...
class Maze:
    def __init__(self, seed: str | None = None) -> None:
        ...
        self.opposite = {c.N: c.S, c.S: c.N, c.W: c.E, c.E: c.W}
    ...
    def create_wall_rects(self) -> None:
        ...
        north_border = pygame.Rect(0, 0, c.MAZE_WIDTH, thickness // 2)
        south_border = pygame.Rect(0, c.MAZE_HEIGHT - thickness // 2, c.MAZE_WIDTH, thickness // 2)
    ...
    def draw(self, surface: pygame.Surface) -> None:
        for y in range(c.GRID_SIZE):
            for x in range(c.GRID_SIZE):
                ...
                left_x = x * c.TILE_SIZE
                top_y = y * c.TILE_SIZE
                right_x = left_x + c.TILE_SIZE
                bottom_y = top_y + c.TILE_SIZE
                ...
                if y == 0: # North
                    pygame.draw.line(surface, c.CORN_WALL_COLOR, (left_x, top_y), (right_x, top_y))
                if x == 0: # West
                    pygame.draw.line(surface, c.CORN_WALL_COLOR, (left_x, top_y), (left_x, bottom_y))
